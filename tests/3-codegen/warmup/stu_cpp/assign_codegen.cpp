...
void translate_main(CodeGen *codegen) {
    ...
    /*Answer: 首先是返回地址和fp占了16字节
              op0是指针，指向alloca出来的10xi32空间，op0再占栈的8字节，现在一共24字节
              alloca出来的空间再占10x4=40字节，现在一共64字节
              op1、op2也是指针，各占8字节，现在一共80字节
              op3、op4、op5都是i32，各占4字节，现在一共92字节
              由于栈空间需要16字节对齐，因此是96字节
    */ 
